...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"❌ Installation failed: {e}"))
            logger.exception("Installation wizard failed")
            sys.exit(1)

    def _run_interactive_setup(self):
        """Run interactive installation wizard"""
        self.stdout.write(self.style.HTTP_INFO("🔧 Interactive Installation Mode"))
        self._print_separator()
    ...
    def _run_headless_setup(self):
        ...
        self.stdout.write(self.style.HTTP_INFO("🤖 Headless Installation Mode"))
        self._print_separator()
    ...
    def _show_completion_message(self):
        ...
        self.stdout.write(
            "  2. Visit http://localhost:8000/admin/ to access the admin panel"
        )
    ...
    def _show_headless_instructions(self, token):
        ...
        self._print_separator()
        self.stdout.write(self.style.SUCCESS("🔑 Headless installation prepared!"))
        self.stdout.write("")
        ...
        self.stdout.write(
            self.style.WARNING(
                f'⚠ Token expires in {self.options["token_expires"]} hours'
            )
        )
        self.stdout.write(
