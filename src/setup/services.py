...
class InstallationService:
    ...
    def __init__(self):
        ...
        config_path = getattr(
            ...
            Path(settings.BASE_DIR) / ".setup_config.json",
        )
    ...
    def is_installation_complete(self) -> bool:
        ...
        try:
            ...
            return data.get(
                "completed", False
            ) and self._validate_installation_integrity(data)
    ...
    def get_installation_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "admin_created_during_install": installation_data.get(
                    "admin_created", False
                ),
    ...
    def get_setup_progress(self) -> Dict[str, Any]:
        ...
        progress["ready_for_admin_creation"] = (
            progress["database_ready"]
            and progress["migrations_applied"]
            and not progress["admin_exists"]
        )
